...
if exist %programdata%\PostClear\CustomStart.exe (
	...
	%programdata%\PostClear\HelpTool.exe %windir%\System32\notepad.exe "%programdata%\Microsoft\Windows\Start Menu\Programs\Accessories\Блокнот.lnk"
	...
	%programdata%\PostClear\HelpTool.exe %windir%\explorer.exe "%programdata%\Microsoft\Windows\Start Menu\Programs\System Tools\Проводник.lnk"
